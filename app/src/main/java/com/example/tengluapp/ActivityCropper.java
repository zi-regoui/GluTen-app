...
public class ActivityCropper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UCrop.of(imageUri,Uri.fromFile(new File(getCacheDir(),destinationUri)))
                ...
                .start(ActivityCropper.this);
    }

    private void readIntent() {
        Intent intent = getIntent();
        if(intent.getExtras()!=null){
            result = intent.getStringExtra("IMAGE");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode==RESULT_OK && requestCode == UCrop.REQUEST_CROP ){
            ...
            returnIntent.putExtra("RESULTAT",resultUri+"");
